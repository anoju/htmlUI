    ...
    e(2),
      (function (t) {
        t.fn.selectScroll = function (i) {
          ...
          var s = { title: '선택해주세요', data: [], cancelTxt: 'cancel', cancelClass: '', confirmTxt: 'confirm', confirmClass: '', cancel: null, confirm: null, selectedIndex: [0, 0, 0], class: '' };
          ...
          (h.$wheel = []),
            ...
            (h.confirm = function (t) {
              var i = h.getData();
              if ((h.hide(), h.bindSelectedIndex(), t.data.callback)) return void t.data.callback(i);
              if (!(i.length < 1)) {
                var e = '';
                1 === i.length
                  ? (e = i[0].text)
            ...
            (h.attachButtonEvents = function () {
              (h.$confirm = h.$picker.find('.confirm').addClass(h.settings.confirmClass)), h.$confirm.bind('click', { callback: h.settings.confirm }, h.confirm), (h.$cancel = h.$picker.find('.cancel').addClass(h.settings.cancelClass)), h.$cancel.bind('click', { callback: h.settings.cancel }, h.cancel);
            }),
            ...
            (h._createWheel = function (t) {
              ...
              (h.$wheel[t] = new o.default(i[t], { wheel: { selectedIndex: h.settings.selectedIndex[t], wheelWrapperClass: 'wheel-scroll', wheelItemClass: 'wheel-item' }, probeType: 3 })), t === h.settings.maxLevel - 1 && (h.show(), h.attachButtonEvents());
            }),
  ...
  function (t, i, e) {
    ...
    function f(t) {
      ...
      if ('undefined' != typeof MouseEvent)
        try {
          r = new MouseEvent(e, o({ bubbles: h, cancelable: a }, n));
        } catch (t) {
          i();
        }
      else i();
    ...
    function w(t, i, e, s, o, n, r) {
      var h = t - i,
        ...
        f = d ? 4 : 15,
        g = t + (a / l) * (h < 0 ? -1 : 1);
      return d && c && (g = Math.round(g / c) * c), g < s ? ((g = n ? Math.max(s - n / 4, s - (n / f) * a) : s), (m = p)) : g > o && ((g = n ? Math.min(o + n / 4, o + (n / f) * a) : o), (m = p)), { destination: Math.round(g), duration: m };
    }
    function S() {}
    function b(t) {}
    function T(t, i) {
    ...
    function M(t, i) {
      var e = this;
      (this.options = i),
        T('function' == typeof this.options.createTombstone, 'Infinite scroll need createTombstone Function to create tombstone'),
        T('function' == typeof this.options.fetch, 'Infinite scroll need fetch Function to fetch new data.'),
        T('function' == typeof this.options.render, 'Infinite scroll need render Function to render each item.'),
    ...
    var E = (function () {
      ...
      C = (function () {
        ...
        for (var i in t) if (void 0 !== W[t[i]]) return i;
        return !1;
      })(),
      O = h('transform'),
      ...
      N = { transform: O, transitionTimingFunction: h('transitionTimingFunction'), transitionDuration: h('transitionDuration'), transitionDelay: h('transitionDelay'), transformOrigin: h('transformOrigin'), transitionEnd: h('transitionEnd') },
      U = 1,
      B = { touchstart: U, touchmove: U, touchend: U, mousedown: 2, mousemove: 2, mouseup: 2 },
    ...
    (Y.prototype.handleEvent = function (t) {
      ...
      (Y.prototype.fade = function (t, i) {
        ...
        if (!i || this.visible) {
          var s = t ? 250 : 500;
          (t = t ? '1' : '0'),
            (this.wrapperStyle[N.transitionDuration] = s + 'ms'),
      ...
      (Y.prototype.updatePosition = function () {
        if ('vertical' === this.direction) {
          ...
          (this.y = t), this.scroller.options.useTransform ? (this.indicatorStyle[N.transform] = 'translateY(' + t + 'px)' + this.scroller.translateZ) : (this.indicatorStyle.top = t + 'px');
        } else {
          ...
          (this.x = s), this.scroller.options.useTransform ? (this.indicatorStyle[N.transform] = 'translateX(' + s + 'px)' + this.scroller.translateZ) : (this.indicatorStyle.left = s + 'px');
        }
      }),
      (Y.prototype.transitionTime = function () {
        var t = arguments.length > 0 && void 0 !== arguments[0] ? arguments[0] : 0;
        this.indicatorStyle[N.transitionDuration] = t + 'ms';
      }),
      (Y.prototype.transitionTimingFunction = function (t) {
        this.indicatorStyle[N.transitionTimingFunction] = t;
      }),
    ...
    (M.prototype.onScroll = function () {
      ...
      (M.prototype._setupAnimations = function (t, i) {
        ...
        (this.scroller.maxScrollY = -(i - this.wrapperEl.offsetHeight + (this.hasMore ? it : 0))),
          setTimeout(function () {
            for (var i in t) {
              var s = t[i];
      ...
      (function (t) {
        (t.prototype._start = function (t) {
          var i = B[t.type];
          if ((i === U || 0 === t.button) && !(!this.enabled || this.destroyed || (this.initiated && this.initiated !== i))) {
          ...
          (t.prototype._end = function (t) {
            if (this.enabled && !this.destroyed && B[t.type] === this.initiated) {
              (this.initiated = !1), this.options.preventDefault && !u(t.target, this.options.preventDefaultException) && t.preventDefault(), this.options.stopPropagation && t.stopPropagation(), this.trigger('touchEnd', { x: this.x, y: this.y }), (this.isInTransition = !1);
                ...
                if (!this.resetPosition(this.options.bounceTime, q.bounce)) {
                  ...
                  if (this.options.momentum && r < this.options.momentumLimitTime && (a > this.options.momentumLimitDistance || h > this.options.momentumLimitDistance)) {
                    ...
                    var g = (this.directionX === J && d) || (this.directionX === Q && m) ? this.wrapperWidth : 0,
                      ...
                      y = this.hasHorizontalScroll ? w(this.x, this.startX, r, this.maxScrollX, this.minScrollX, g, this.options) : { destination: i, duration: 0 },
                      x = this.hasVerticalScroll ? w(this.y, this.startY, r, this.maxScrollY, this.minScrollY, v, this.options) : { destination: e, duration: 0 };
          ...
          (t.prototype._transitionTime = function () {
            var t = arguments.length > 0 && void 0 !== arguments[0] ? arguments[0] : 0;
            if (((this.scrollerStyle[N.transitionDuration] = t + 'ms'), this.options.wheel)) for (var i = 0; i < this.items.length; i++) this.items[i].style[N.transitionDuration] = t + 'ms';
          ...
          (t.prototype._transitionTimingFunction = function (t) {
            if (((this.scrollerStyle[N.transitionTimingFunction] = t), this.options.wheel)) for (var i = 0; i < this.items.length; i++) this.items[i].style[N.transitionTimingFunction] = t;
          ...
          (t.prototype._transitionEnd = function (t) {
            t.target === this.scroller && this.isInTransition && (this._transitionTime(), (!this.pulling || this.movingDirectionY === Z) && !this.resetPosition(this.options.bounceTime, q.bounce) && ((this.isInTransition = !1), this.options.probeType !== tt && this.trigger('scrollEnd', { x: this.x, y: this.y })));
          }),
          (t.prototype._translate = function (t, i, e) {
            if ((T(!n(t) && !n(i), 'Translate x or y is null or undefined.'), n(e) && (e = this.scale), this.options.useTransform ? (this.scrollerStyle[N.transform] = 'translate(' + t + 'px,' + i + 'px) scale(' + e + ')' + this.translateZ) : ((t = Math.round(t)), (i = Math.round(i)), (this.scrollerStyle.left = t + 'px'), (this.scrollerStyle.top = i + 'px')), this.options.wheel))
              for (var s = this.options.wheel.rotate, o = void 0 === s ? 25 : s, r = 0; r < this.items.length; r++) {
                var h = o * (i / this.itemHeight + r);
                this.items[r].style[N.transform] = 'rotateX(' + h + 'deg)';
              }
          ...
          (t.prototype._animate = function (t, i, e, o) {
            function n() {
              var u = s();
              if (u >= d) return (r.isAnimating = !1), r._translate(t, i, c), r.trigger('scroll', { x: r.x, y: r.y }), void (r.pulling || r.resetPosition(r.options.bounceTime) || r.trigger('scrollEnd', { x: r.x, y: r.y }));
              u = (u - p) / e;
              var m = o(u),
                f = (t - h) * m + h,
                g = (i - a) * m + a,
                v = (c - l) * m + l;
              r._translate(f, g, v), r.isAnimating && (r.animateTimer = V(n)), r.options.probeType === tt && r.trigger('scroll', { x: r.x, y: r.y });
            }
            var r = this,
              h = this.x,
              a = this.y,
          ...
          (t.prototype.getComputedPosition = function () {
            var t = window.getComputedStyle(this.scroller, null),
              i = void 0,
              e = void 0;
            return this.options.useTransform ? ((t = t[N.transform].split(')')[0].split(', ')), (i = +(t[12] || t[4])), (e = +(t[13] || t[5]))) : ((i = +t.left.replace(/[^-\d.]/g, '')), (e = +t.top.replace(/[^-\d.]/g, ''))), { x: i, y: e };
          }),
          (t.prototype.stop = function () {
            ...
            } else !this.options.useTransition && this.isAnimating && ((this.isAnimating = !1), j(this.animateTimer), this.trigger('scrollEnd', { x: this.x, y: this.y }), (this.stopFromTransition = !0));
          }),
      ...
      (function (t) {
        (t.prototype._initSnap = function () {
            ...
            this.on('refresh', function () {
              if (((t.pages = []), t.wrapperWidth && t.wrapperHeight && t.scrollerWidth && t.scrollerHeight)) {
                var e = i.stepX || t.wrapperWidth,
                  ...
                  u = void 0,
                  m = void 0;
                if (s) for (c = s.length, u = -1; l < c; l++) (m = d(s[l])), (0 === l || m.left <= d(s[l - 1]).left) && ((p = 0), u++), t.pages[p] || (t.pages[p] = []), (n = Math.max(-m.left, t.maxScrollX)), (r = Math.max(-m.top, t.maxScrollY)), (h = n - Math.round(m.width / 2)), (a = r - Math.round(m.height / 2)), (t.pages[p][u] = { x: n, y: r, width: m.width, height: m.height, cx: h, cy: a }), n > t.maxScrollX && p++;
                else
                  for (h = Math.round(e / 2), a = Math.round(o / 2); n > -t.scrollerWidth; ) {
                    for (t.pages[l] = [], c = 0, r = 0; r > -t.scrollerHeight; ) (t.pages[l][c] = { x: Math.max(n, t.maxScrollX), y: Math.max(r, t.maxScrollY), width: e, height: o, cx: n - h, cy: r - a }), (r -= o), c++;
                    (n -= e), l++;
                  }
                t._checkSnapLoop();
                var f = i._loopX ? 1 : 0,
          ...
          (t.prototype._nearestSnap = function (t, i) {
            ...
            return e === this.currentPage.pageX && ((e += this.directionX), e < 0 ? (e = 0) : e >= this.pages.length && (e = this.pages.length - 1), (t = this.pages[e][0].x)), o === this.currentPage.pageY && ((o += this.directionY), o < 0 ? (o = 0) : o >= this.pages[0].length && (o = this.pages[0].length - 1), (i = this.pages[0][o].y)), { x: t, y: i, pageX: e, pageY: o };
          }),
          ...
          (t.prototype.getCurrentPage = function () {
            var t = this.options.snap;
            return t ? (t.loop ? (t._loopX ? o({}, this.currentPage, { pageX: this.currentPage.pageX - 1 }) : o({}, this.currentPage, { pageY: this.currentPage.pageY - 1 })) : this.currentPage) : null;
          });
      })(P),
      (function (t) {
      ...
      (function (t) {
        (t.prototype._initScrollbar = function () {
          ...
          this.indicators = [];
          var r = void 0;
          this.options.scrollX && ((r = { el: _('horizontal'), direction: 'horizontal', fade: s, interactive: n }), this._insertScrollBar(r.el), this.indicators.push(new Y(this, r))),
            this.options.scrollY && ((r = { el: _('vertical'), direction: 'vertical', fade: s, interactive: n }), this._insertScrollBar(r.el), this.indicators.push(new Y(this, r))),
            this.on('refresh', function () {
        ...
        (t.prototype._initPullUp = function () {
          ...
          (t.prototype._checkToEnd = function (t) {
            var i = this,
              ...
              s = void 0 === e ? 0 : e;
            this.movingDirectionY === Z &&
              t.y <= this.maxScrollY + s &&
        ...
        (t.prototype._initMouseWheel = function () {
          ...
          (t.prototype._onMouseWheel = function (t) {
            ...
            if (this.enabled) {
              ...
              (d = this.x + Math.round(this.hasHorizontalScroll ? l : 0)), (u = this.y + Math.round(this.hasVerticalScroll ? c : 0)), (this.movingDirectionX = this.directionX = l > 0 ? -1 : l < 0 ? 1 : 0), (this.movingDirectionY = this.directionY = c > 0 ? -1 : c < 0 ? 1 : 0), d > this.minScrollX ? (d = this.minScrollX) : d < this.maxScrollX && (d = this.maxScrollX), u > this.minScrollY ? (u = this.minScrollY) : u < this.maxScrollY && (u = this.maxScrollY), this.scrollTo(d, u, a, q.swipe), this.trigger('scroll', { x: this.x, y: this.y });
            }
          });
      })(P),
      (function (t) {
        (t.prototype._initZoom = function () {
          var t = this.options.zoom,
            ...
            n = t.max,
            r = void 0 === n ? 4 : n;
          (this.scale = Math.min(Math.max(e, o), r)), this.setScale(this.scale), (this.scrollerStyle[N.transformOrigin] = '0 0');
        }),
          ...
          (t.prototype._zoom = function (t) {
            if (this.enabled && !this.destroyed && B[t.type] === this.initiated) {
              ...
              var a = this.options.zoom,
                ...
                p = a.max,
                d = void 0 === p ? 4 : p;
              h < c ? (h = 0.5 * c * Math.pow(2, h / c)) : h > d && (h = 2 * d * Math.pow(0.5, d / h));
