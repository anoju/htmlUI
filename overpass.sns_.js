(function(e) {
    ...
    elandmall.sns = {
        sharePage: function(a) {
            ...
            if ("FB" == a.sns)
                b = "https://wwww.facebook.com/sharer.php?u\x3d" + encodeURIComponent(a.url);
            else if ("KT" == a.sns)
                ...
                "undefined" != typeof a.mobile_yn && "Y" == a.mobile_yn ? Kakao.Story.open({
                    url: a.url,
                    text: d
                }) : Kakao.Story.share({
                    url: a.url,
                ...
                b = "http://blog.naver.com/openapi/share?serviceCode\x3dshare\x26url\x3d" + encodeURIComponent(a.url);
            else if ("LN" == a.sns)
                b = "http://line.me/R/msg/text/?" + encodeURIComponent(d + a.url);
            else if ("IG" == a.sns)
                b = "elandbridge://share/instagram?imgUrl\x3d" + a.img;
            else if ("UC" == a.sns) {
                ...
                if ("undefined" != typeof a.mobile_yn && "Y" == a.mobile_yn)
                    e("a.btn_close", "[id^\x3dsns_lyr]").click(),
                    0 < e("#bundle_detail").length ? elandmall.layer.createLayerForLayer({
                    ...
                    window.clipboardData ? (window.clipboardData.setData("Text", a.url),
            ...
            "KT" != a.sns && "UC" != a.sns && "SM" != a.sns && "KS" != a.sns && ("undefined" != typeof elandmall.global.app_cd && "" != elandmall.global.app_cd && "IG" != a.sns && ("iOS" == elandmall.global.app_cd ? "LN" != a.sns && (b = "elandbridge://browser/?url\x3d" + b) : b = "elandbridge://browser/?url\x3d" + encodeURIComponent(b)),
